...
function buildParsedPlcSnapshot(machine) {
  ...
  const plcConfig = {
    ...
    blockRegister: toInt(parsed.blockRegister ?? machine?.plc_block_register),
    endOkRegister: toInt(parsed.endOkRegister ?? machine?.plc_end_ok_register),
    endNgRegister: toInt(parsed.endNgRegister ?? machine?.plc_end_ng_register),
    ...
    bypassRegister: toInt(parsed.bypassRegister ?? machine?.plc_bypass_register),
...
async function normalizePayload(body = {}, existing = null) {
  ...
  const plcConfig = {
    ...
    blockRegister: toInt(cfgRaw.blockRegister ?? body.plcBlockRegister ?? body.plc_block_register ?? existing?.plc_block_register ?? parsedExisting.blockRegister ?? null),
    endOkRegister: toInt(cfgRaw.endOkRegister ?? body.plcEndOkRegister ?? body.plc_end_ok_register ?? existing?.plc_end_ok_register ?? parsedExisting.endOkRegister ?? null),
    endNgRegister: toInt(cfgRaw.endNgRegister ?? body.plcEndNgRegister ?? body.plc_end_ng_register ?? existing?.plc_end_ng_register ?? parsedExisting.endNgRegister ?? null),
    ...
    bypassRegister: toInt(cfgRaw.bypassRegister ?? body.plcBypassRegister ?? existing?.plc_bypass_register ?? parsedExisting.bypassRegister ?? null),
