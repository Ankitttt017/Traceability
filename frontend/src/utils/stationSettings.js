...
export function getStationFeatures(stationNo, settings = {}) {
  ...
  return {
    ...
    plcCommunication: stationSettings.plcCommunication !== false,
    ...
    rejectionCategoryCR: stationSettings.rejectionCategoryCR !== false,
    rejectionCategoryCRAM: stationSettings.rejectionCategoryCRAM !== false,
    rejectionCategoryMR: stationSettings.rejectionCategoryMR !== false,
    ...
    validateQrFormat: stationSettings.validateQrFormat !== false,
...
export function getStationFeatureCoverage(settings = {}, stations = []) {
  ...
  return values.reduce(
    (acc, entry) => ({
      ...
      plcCommunicationEnabled: acc.plcCommunicationEnabled + (entry.plcCommunication !== false ? 1 : 0),
